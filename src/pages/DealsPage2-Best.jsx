...
const DealsPage2 = () => {
  ...
  // Load deal categories for deal category buttons
  useEffect(() => {
  ...
  const loadHotDeals = useCallback(async (additionalFilters, page, location) => {
    ...
    const mergedFilters = { ...filters, ...additionalFilters, page, limit: filters.limit };
                  ...
                  >
                    ...
                    <SwiperSlide style={{ width: 'auto', paddingLeft: showCategoryNav ? '8px' : '8px' }}>
                      <button
                        ...
                        className={`relative flex items-center gap-2 px-2 py-3 text-sm font-medium whitespace-nowrap transition-colors ${
                    ...
                    {allCategories.map((category, categoryIndex) => {
                      ...
                      <SwiperSlide key={category._id} style={{ width: 'auto', paddingLeft: (showCategoryNav && categoryIndex === 0) ? '8px' : '0' }}>
                        <button
                          ...
                          className={`relative flex items-center gap-2 px-0 py-3 text-sm font-medium whitespace-nowrap transition-colors ${
